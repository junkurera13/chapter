...
export const chapterOpenRouter = createOpenRouter({
...
export const chapterResearchModelId =
  process.env.OPENROUTER_RESEARCH_MODEL ?? chapterConversationModelId;

export const chapterConversationModel = chapterOpenRouter(
  chapterConversationModelId,
);

export const chapterResearchModel = chapterOpenRouter(chapterResearchModelId);
